...
class AssignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assign" do
    assert_difference('Assign.count') do
      post assigns_url, params: { assign: { task_id: @assign.task_id, user_id: @assign.user_id } }
    end
  ...
  test "should update assign" do
    patch assign_url(@assign), params: { assign: { task_id: @assign.task_id, user_id: @assign.user_id } }
